...
const ViewUser = () => {
    ...
    return (
        <div className="container text-center pt-5 mt-5  flex-grow-1" style={{boxSizing: "border-box", fontSize: "14px"}}>
                ...
                <div className="row">
                    <div className="col-12 p-0" >
                        <nav aria-label="breadcrumb" style={{backgroundColor: '#c5cee4'}}>
                            <ol className="breadcrumb py-3 px-3">
                                ...
                                <li className="breadcrumb-item"><Link to="/dashboard" style={{textDecoration: "none"}}>Users</Link></li>
                                <li className="breadcrumb-item active fw-bold" aria-current="page">{user.nom} {user.prenom}</li>
                            </ol>
                        </nav>
                    </div>
                    <div className="col-md-5">
                        <div className="row">
                            ...
                            <div className="col-12 p-0 px-2 pb-3 mb-3 bg-light border">
                                ...
                                <div className="d-flex justify-content-between pt-2 pb-1 px-3">
                    ...
                    <div className="col-md-7 ps-md-4">
                        <div className="row">
                            ...
                            <div className="col-12 px-3 py-3 bg-light border">
                                <h6 className="d-flex align-items-center mb-3 fw-bold py-3">Project
                                    Status</h6>
