...
const AdminProfile = () => {
    ...
    return (
        ...
        <div className="container text-center pt-4 mt-3 flex-grow-1" style={{ boxSizing: "border-box", fontSize: "14px" }}>
            <div className="container">
                <h1 className='text-start fw-semibold'>Profile</h1>
                            ...
                            <div className="col-12 p-0 px-3 py-3 mb-3 bg-light border">
                                <div className="d-flex flex-column align-items-center">
                                    ...
                                    <div className="d-flex ">
                                        <Link to="/admin/profile/edit" className="btn btn-lg btn-dark rounded-0 follow me-2">Edit Profile</Link>
                                    </div>
                                </div>
                            </div>
