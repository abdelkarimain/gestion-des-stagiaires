    ...
    return (
        <div className="text-center py-5 my-5 mx-auto  flex-grow-1 d-flex justify-content-center ">
            <div className="pt-5 mt-5">
                ...
                <div className="mt-5">
                    <Link to="/" className="btn m-2 btn-primary"><i className="fa-solid fa-house"></i> Back Home</Link>
                    <Link to="/contact" className="btn m-2 btn-success"><i className="fa-solid fa-address-book"></i> Contact Us</Link>
                </div>
            </div>
        </div>
